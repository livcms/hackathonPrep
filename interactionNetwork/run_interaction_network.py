...
def main():
    ...
    home_dir = ""
    indir = "{}output/fixed/{}GeV/".format(home_dir, args.pt)
    #indir = "{}output".format(home_dir)
    ...
    partition = {'train': graph_files[IDs[:700]],
                 'test':  graph_files[IDs[700:850]],
                 'val': graph_files[IDs[850:995]]}
